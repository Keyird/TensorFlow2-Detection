...
from networks.yolov4 import yolo_body, yolo_eval
...
image_ids = open('D:/Project/yolov4/VOCdevkit/VOC2007/ImageSets/Main/test.txt').read().strip().split()
...
for image_id in tqdm(image_ids):
    image_path = "D:/Project/yolov4/VOCdevkit/VOC2007/JPEGImages/"+image_id+".jpg"
